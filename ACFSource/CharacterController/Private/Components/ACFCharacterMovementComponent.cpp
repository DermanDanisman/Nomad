...
FACFLocomotionState* UACFCharacterMovementComponent::GetLocomotionStateStruct(ELocomotionState State)
{
    return LocomotionStates.FindByKey(State);
}

const FACFLocomotionState* UACFCharacterMovementComponent::GetLocomotionStateStructConst(ELocomotionState State) const
{
    return LocomotionStates.FindByKey(State);
}

FACFLocomotionState UACFCharacterMovementComponent::GetLocomotionStateStructByValue(ELocomotionState State) const
{
    const FACFLocomotionState* Found = LocomotionStates.FindByKey(State);
    return Found ? *Found : FACFLocomotionState();
}
