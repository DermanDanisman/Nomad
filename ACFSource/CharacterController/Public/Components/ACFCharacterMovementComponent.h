...
public:
    ...
    /**
     * Returns a pointer to the locomotion state struct for the given state, or nullptr if not found.
     */
    FACFLocomotionState* GetLocomotionStateStruct(ELocomotionState State);

    /**
     * Returns a const pointer to the locomotion state struct for the given state, or nullptr if not found.
     */
    const FACFLocomotionState* GetLocomotionStateStructConst(ELocomotionState State) const;

    UFUNCTION(BlueprintPure, Category="ACF|Movement")
    FACFLocomotionState GetLocomotionStateStructByValue(ELocomotionState State) const;
