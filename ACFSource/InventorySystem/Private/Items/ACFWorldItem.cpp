...
void AACFWorldItem::OnSaved_Implementation()
{
    IALSSavableInterface::OnSaved_Implementation();
}

bool AACFWorldItem::ShouldBeIgnored_Implementation()
{
    return IALSSavableInterface::ShouldBeIgnored_Implementation();
}

TArray<UActorComponent*> AACFWorldItem::GetComponentsToSave_Implementation() const
{
    return IALSSavableInterface::GetComponentsToSave_Implementation();
}
