...
void UACFBaseAction::OnActionStarted_Implementation(const FString& contextString, AActor* InteractedActor, FGameplayTag ItemSlotTag) {}
...
bool UACFBaseAction::CanExecuteAction_Implementation(class ACharacter* owner, FGameplayTag ItemSlotTag)
{
    return true;
}
...
int32 UACFBaseAction::GetActiveQuickbarIndex_Implementation(const int32 CurrentActiveQuickbarIndex)
{
    return CurrentActiveQuickbarIndex;
}

int32 UACFBaseAction::GetQuickbarSlotIndex_Implementation(const int32 CurrentQuickbarSlotIndex)
{
    return CurrentQuickbarSlotIndex;
}
...
void UACFBaseAction::HandleMontageStarted(UAnimMontage* inAnimMontage)
{
    ...
    {
        animinst->OnMontageEnded.AddDynamic(this, &UACFBaseAction::HandleMontageFinished);
    }
}
...
void UACFBaseAction::UnbinAnimationEvents()
{
    ...
    if (animinst)
    {
        ...
        animinst->OnMontageEnded.RemoveDynamic(this, &UACFBaseAction::HandleMontageFinished);
    }
}
...
void UACFBaseAction::Internal_OnActivated(class UACFActionsManagerComponent* actionManger, class UAnimMontage* inAnimMontage, const FString& contextString, AActor* InteractedActor, const FGameplayTag& ItemSlotTag)
{
    ...
    OnActionStarted(contextString, InteractedActor, ItemSlotTag);
...
void UACFBaseAction::StartCooldown()
{
    if (ActionsManager)
    {
        ActionsManager->StartCooldown(ActionTag, this);
    }
}

void UACFBaseAction::SetActionConfig(const FActionConfig& newConfig)
{
    ActionConfig = newConfig;
}

void UACFBaseAction::SetAnimMontage(UAnimMontage* newMontage)
{
