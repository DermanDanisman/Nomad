...
#include "StatusEffectSystem/Public/ACFStatusTypes.h"
...
public:
    ...
    virtual void AddStatusEffect(UACFBaseStatusEffect* StatusEffect, AActor* instigator = nullptr);

    UFUNCTION(BlueprintCallable, Server, Reliable,Category = "ACF")
    void RemoveStatusEffect(FGameplayTag StatusEffectTag);

    UFUNCTION(BlueprintCallable, Server, Reliable,Category = "ACF")
    virtual void CreateAndApplyStatusEffect(TSubclassOf<UACFBaseStatusEffect> StatusEffectToConstruct, AActor* instigator = nullptr);
