...
private:
    ...
    /** Returns true if player should have slowed movement based on cached values */
     ...
     * @param ActualTemperature  Current ambient temperature.
     * @param NormalizedTempForCurve  Pre-calculated normalized temperature for curve input.
     * @return Modifier value to add to base decay.
     */
     ...
     */
    void TryApplyStatusEffect(const TSubclassOf<UNomadBaseStatusEffect>& InStatusEffectClass) const;
