...
public:
    ...
    UFUNCTION(BlueprintPure, Category = ARS)
    FORCEINLINE int32 GetTotaleExpToNextLevel() const
    {
    ...
    UFUNCTION(BlueprintPure, Category = ARS)
    FORCEINLINE int32 GetCurrentExp() const
    {
        return CurrentExps;
    };
    ...
    /*Returns current level of the character*/
    UFUNCTION(BlueprintPure, Category = ARS)
    FORCEINLINE bool CanLevelUp() const
    {
        return LevelingType != ELevelingType::ECantLevelUp;
    };
    ...
    UFUNCTION(BlueprintPure, Category = ARS)
    FORCEINLINE int32 GetAvailablePerks() const
    {
        return Perks;
    };
    ...
    UFUNCTION(BlueprintCallable, Category = ARS)
    bool HasValidStatistic(FGameplayTag stat) const
    {
        return AttributeSet.Statistics.Contains(stat);
    };

    UFUNCTION(BlueprintCallable, Category = ARS)
    bool HasValidAttribute(FGameplayTag param) const
    {
        return AttributeSet.Parameters.Contains(param);
    };

    UFUNCTION(BlueprintCallable, Category = ARS)
    bool HasValidPrimaryAttribute(FGameplayTag att) const
    {
        return AttributeSet.Attributes.Contains(att);
    };
