...
public:
    ...
    bool GetEnableFallDamage() const
    {
        return bEnableFallDamage;
    }

    UFUNCTION(BlueprintCallable, Category = ACF)
    void SetEnableFallDamage(bool val)
    {
        bEnableFallDamage = val;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    bool GetTriggerActionOnLand() const
    {
        return bTriggerActionOnLand;
    }

    UFUNCTION(BlueprintCallable, Category = ACF)
    void SetTriggerActionOnLand(bool val)
    {
        bTriggerActionOnLand = val;
    }
...
protected:
    ...
    // Component to apply camera effects like fade
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = ACF)
    void TriggerAction(FGameplayTag Action, EActionPriority Priority, bool canBeStored = false, const FString& contextString = "", AActor* InteractedActor = nullptr, FGameplayTag ItemSlotTag = FGameplayTag());
    ...
    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UACFCharacterMovementComponent* GetACFCharacterMovementComponent() const
    {
        return LocomotionComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UACFActionsManagerComponent* GetActionsComponent() const
    {
        return ActionsComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UARSStatisticsComponent* GetStatisticsComponent() const
    {
        return StatisticsComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UACFEquipmentComponent* GetEquipmentComponent() const
    {
    ...
    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UACFDamageHandlerComponent* GetDamageHandlerComponent() const
    {
        return DamageHandlerComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UACFRagdollComponent* GetRagdollComponent() const
    {
        return RagdollComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UMotionWarpingComponent* GetMotionWarpComponent() const
    {
        return MotionWarpComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UCCMFadeableActorComponent* GetMaterialsOverrideComp() const
    {
        return FadeComp;
    }
    ...
    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE FText GetCharacterName() const
    {
        return CharacterName;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE class UAudioComponent* GetAudioComp() const
    {
        return AudioComp;
    }

    UFUNCTION(BlueprintPure, Category = ACF)
    FORCEINLINE ECombatType GetCombatType() const
    {
        return CombatType;
    }
